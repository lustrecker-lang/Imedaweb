...
import { Mountain, LayoutDashboard, Home, Building, Pencil, Database, Mail, School, Briefcase, GraduationCap, Newspaper, DatabaseZap, Tag, Library, Star, BrainCircuit, Presentation, FolderKanban, BriefcaseBusiness, Construction, Landmark } from "lucide-react";
        ...
        <SidebarContent>
          <SidebarMenu>
            ...
            <SidebarMenuItem asChild>
             ...
             <SidebarMenuItem asChild>
              <Link href="/admin/seed-publications">
            ...
            <SidebarMenuItem asChild>
              <Link href="/admin/seed-careers">
                <SidebarMenuButton tooltip="Seed Careers">
                  <BriefcaseBusiness />
            ...
            <SidebarMenuItem asChild>
              <Link href="/admin/seed-services">
                <SidebarMenuButton tooltip="Seed Services">
                  <Construction />
                  <span className="text-sm">Seed Services</span>
                </SidebarMenuButton>
              </Link>
            </SidebarMenuItem>
            <SidebarMenuItem asChild>
              <Link href="/admin/seed-legal">
                <SidebarMenuButton tooltip="Seed Legal">
                  <Landmark />
                  <span className="text-sm">Seed Legal</span>
                </SidebarMenuButton>
              </Link>
            </SidebarMenuItem>
          </SidebarMenu>
