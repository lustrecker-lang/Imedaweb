...
const pageToSeed = {
    ...
    sections: [
        ...
        {
            id: "spec-1", title: "Leadership et Management Stratégique", content: "Développer la vision et les compétences des dirigeants pour naviguer la complexité."
        },
        {
            id: "spec-2", title: "Transformation Digitale", content: "Accompagner les organisations dans l'adoption des nouvelles technologies."
        },
        {
            id: "spec-3", title: "Finance et Gouvernance", content: "Renforcer la performance financière et les pratiques de bonne gouvernance."
        },
        {
            id: "spec-4", title: "Gestion de Projets et Programmes", content: "Piloter des projets complexes avec des méthodologies éprouvées (PMI, PRINCE2)."
        },
        {
            id: "spec-5", title: "Développement Durable et RSE", content: "Intégrer les enjeux environnementaux et sociaux dans la stratégie d'entreprise."
        },
        {
            id: "spec-6", title: "Excellence Opérationnelle", content: "Optimiser les processus et la chaîne de valeur pour une meilleure efficacité."
        },
        {
            id: "spec-7", title: "Politiques Publiques et Réformes", content: "Accompagner les institutions publiques dans la conception et la mise en œuvre des réformes."
        },
        {
            id: "spec-8", title: "Marketing et Développement Commercial", content: "Adapter les stratégies marketing et commerciales aux nouveaux enjeux du marché."
        },
        {
        ...
        {
            id: "step-1", title: "Découvrir", content: "Immersion dans votre contexte, analyse de vos enjeux et définition commune des objectifs."
        },
        {
            id: "step-2", title: "Concevoir", content: "Co-conception d'une solution sur-mesure, définition des livrables et des indicateurs de succès."
        },
        {
            id: "step-3", title: "Développer", content: "Mise en œuvre du programme avec nos experts, en mode projet agile et collaboratif."
        },
        {
            id: "step-4", title: "Livrer", content: "Déploiement, évaluation de l'impact et planification des prochaines étapes pour pérenniser les acquis."
        },
        {
            id: "format-1",
